...
export const FUNDS = {
  ...
  "SW BlackRock Gold & General Pn CS8": {
    ...
    asAt: "06 Aug 2026",
    holdings: [
      { rank: 1,  name: "Barrick Gold Corp",         ticker: "ABX.TO",  weight: 8.2 },
      { rank: 2,  name: "Agnico Eagle Mines",        ticker: "AEM.TO",  weight: 6.2 },
      { rank: 3,  name: "Newmont Corporation",       ticker: "NEM",     weight: 6.0 },
      { rank: 4,  name: "Wheaton Precious Metals",   ticker: "WPM.TO",  weight: 5.5 },
      { rank: 5,  name: "AngloGold Ashanti",         ticker: "AU",      weight: 5.5 },
      { rank: 6,  name: "Franco-Nevada Corp",        ticker: "FNV.TO",  weight: 4.7 },
  ...
  "SW UK Real Estate Pn CS8": {
    ...
    holdings: [
      ...
      { rank: 6,  name: "Unite Group",                  ticker: "UTG.L",  weight: 4.4 },
      ...
      { rank: 9,  name: "Shaftesbury Capital",          ticker: "SHCL.XC", weight: 3.9 },
  ...
  "SW Schroder US Smaller Companies CS8": {
    ...
    asAt: "05 Aug 2026",
    holdings: [
      { rank: 1,  name: "ICU Medical Inc",              ticker: "ICUI",   weight: 2.6 },
      { rank: 2,  name: "Commvault Systems Inc",        ticker: "CVLT",   weight: 2.1 },
      { rank: 3,  name: "Repligen Corp",                ticker: "RGEN",   weight: 2.0 },
