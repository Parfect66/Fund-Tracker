...
//
// range=3mo&interval=1d gives ~90 days of daily closes. We always return the
// full window; the client slices it to the 30- or 90-day sparkline view via a
// toggle, so switching needs no refetch. We return:
//   price          latest price (meta.regularMarketPrice)
//   previousClose  the prior trading day's close (second-last close in series)
//   series         the daily closes, for the sparkline
//
